package com.meshnetwork.meshnetworks.testapp.composable
...
import com.meshnetwork.meshnetworks.meshnetworksConstants.LOG_TAG
...
fun interface ConnectBluetoothLauncher {
    fun launch(bluetoothConfig: meshnetworksBluetoothState)
}
...
fun rememberBluetoothConnectLauncher(
    ...
    var associateAfterPermissionConfig: meshnetworksBluetoothState? by remember {
        mutableStateOf(null)
    }
    ...
    fun associate(config: meshnetworksBluetoothState) {
