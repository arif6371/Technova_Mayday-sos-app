...
import com.meshnetwork.meshnetworks.testapp.viewmodel.ReceiveUiState
import com.meshnetwork.meshnetworks.testapp.viewmodel.ReceiveViewModel
    ...
    fun openTransfer(transfer: TestAppServer.IncomingTransfer) {
        ...
        if(file != null && transfer.status == TestAppServer.Status.COMPLETED) {
            val uri = FileProvider.getUriForFile(
                context, "com.meshnetwork.meshnetworks.testapp.fileprovider", file
            )
