...
import com.meshnetwork.meshnetworks.testapp.NEARBY_WIFI_PERMISSION_NAME
...
import com.meshnetwork.meshnetworks.testapp.composable.ConnectWifiLauncherResult
import com.meshnetwork.meshnetworks.testapp.composable.ConnectWifiLauncherStatus
import com.meshnetwork.meshnetworks.testapp.composable.remembermeshnetworksConnectLauncher
import com.meshnetwork.meshnetworks.testapp.hasBluetoothConnectPermission
import com.meshnetwork.meshnetworks.testapp.hasNearbyWifiDevicesOrLocationPermission
import com.meshnetwork.meshnetworks.testapp.viewmodel.LocalVirtualNodeUiState
import com.meshnetwork.meshnetworks.testapp.viewmodel.LocalVirtualNodeViewModel
import com.meshnetwork.meshnetworks.vnet.AndroidVirtualNode
import com.meshnetwork.meshnetworks.vnet.meshnetworksConnectLink
...
fun LocalVirtualNodeScreen(
    ...
    val connectLauncher = remembermeshnetworksConnectLauncher(
        logger = logger,
        onStatusChange = {
    ...
    val qrCodeScannerLauncher = rememberLauncherForActivityResult(
        ...
        if(link != null) {
            try {
                ...
                val connectLink = meshnetworksConnectLink.parseUri(
                    uri = link,
                    ...
                    OutlinedButton(
                        ...
                        onClick = {
                            ...
                            qrCodeScannerLauncher.launch(ScanOptions().apply {
                                ...
                                setPrompt("Enable the hotspot in the meshnetworks app on the device " +
