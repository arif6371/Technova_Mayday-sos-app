...
import com.meshnetwork.meshnetworks.ext.connectBand
import com.meshnetwork.meshnetworks.ext.encodeAsHex
import com.meshnetwork.meshnetworks.ext.toPrettyString
import com.meshnetwork.meshnetworks.ext.unspecifiedIpv6Address
import com.meshnetwork.meshnetworks.ext.withoutScope
import com.meshnetwork.meshnetworks.log.MNetLogger
import com.meshnetwork.meshnetworks.util.randomString
...
class WifiDirectManager(
    ...
    private fun makeWifiP2pServiceInfo(addr: Int): WifiP2pDnsSdServiceInfo {
        return WifiP2pDnsSdServiceInfo.newInstance(
            addr.encodeAsHex(), meshnetworksWifiManagerAndroid.WIFI_DIRECT_SERVICE_TYPE, emptyMap()
        )
    }
    ...
    internal suspend fun startWifiDirectGroup(
        ...
        val groupStartedOk = withTimeoutOrNull(meshnetworksWifiManagerAndroid.HOTSPOT_TIMEOUT) {
    ...
    suspend fun stopWifiDirectGroup(): Boolean {
        ...
        return withTimeoutOrNull(meshnetworksWifiManagerAndroid.HOTSPOT_TIMEOUT) {
