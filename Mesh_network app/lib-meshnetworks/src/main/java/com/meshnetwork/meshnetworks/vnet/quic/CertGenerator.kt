package com.meshnetwork.meshnetworks.vnet.quic
...
fun generateX509Cert(
    ...
    issuerName: X500Name = X500Name("CN=meshnetworks"),
    subjectName: X500Name = X500Name("CN=meshnetworks, OU=Mesh Net, O=meshnetwork FZLLC, L=Dubai, C=AE"),
) : X509Certificate{
